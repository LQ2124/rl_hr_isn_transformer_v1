...
if __name__ == '__main__':
    ...
    parser.add_argument('--selector_hidden_dim', type=int, default=64,
                        help='hidden dimension for temporal input selection network')
    parser.add_argument('--selector_dropout', type=float, default=0.1,
                        help='dropout in temporal input selection network')
    parser.add_argument('--selector_temperature', type=float, default=1.0,
                        help='softmax temperature for temporal selection logits')

    # sparsity regularization
    parser.add_argument('--sparse_lambda', type=float, default=0.0,
                        help='weight of sparsity regularization')
    parser.add_argument('--sparse_type', type=str, default='entropy',
    ...
    parser.add_argument('--actor_hidden_dim', type=int, default=64,
                        help='hidden dimension for lightweight actor')
    ...
    parser.add_argument('--rl_warmup_epochs', type=int, default=0,
                        help='number of warmup epochs before enabling RL loss')

    # reward config
    parser.add_argument('--reward_type', type=str, default='improve_over_static',
                        help='reward type, options: [improve_over_static, neg_dynamic_loss, normalized_improve_over_static]')
    parser.add_argument('--reward_scale', type=float, default=1.0,
                        help='scaling factor for reward')

    # action scale
    parser.add_argument('--alpha_scale', type=float, default=0.1,
    ...
    parser.add_argument('--loss', type=str, default='MSE', help='loss function, options: [MSE, MAE, Huber]')
    parser.add_argument('--huber_delta', type=float, default=1.0, help='delta parameter for Huber loss')
